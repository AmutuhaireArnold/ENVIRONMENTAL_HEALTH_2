    ...
    <div class="wrap">
        ...
        <div class="member-level">
            <div class="member-level-head">
                <div><span class="tag mono">ARCHIVE · {{ $committee->term_label }}</span>
                    <h2 class="display">{{ $committee->name }}</h2>
                </div>
        ...
        <div class="committee-archive">
            ...
            <div class="committee-pair-nav">
                @if ($prev)
                <a class="committee-arrow-card" href="/committees/{{ $prev->slug }}"><span class="arrow">←</span>
                    <div><span class="label">ARCHIVE</span>
                        <h4>{{ $prev->name }}</h4>
                    </div>
                </a>
                @else
                ...
                <a class="committee-arrow-card" href="/corporate">
                    <div><span class="label">CURRENT</span>
                        <h4>Back to Central Executive Committee</h4>
                    </div>
                </a>
                @if ($next)
                <a class="committee-arrow-card" href="/committees/{{ $next->slug }}">
                    <div><span class="label">ARCHIVE</span>
                        <h4>{{ $next->name }}</h4>
