...
@section('title', 'Associations — FEHSU')
@section('description', 'Meet FEHSU\'s Advisory Board and the partner associations that support the federation\'s mission across Uganda\'s environmental health sector.')
...
<div><span class="label">DIRECTORY</span><h4>Central Executive Committee</h4></div>
<span class="arrow">→</span>
</a>
<a class="committee-arrow-card" href="/committees">
<div><span class="label">DIRECTORY</span><h4>National Executive Committee</h4></div>
<span class="arrow">→</span>
</a>
<a class="committee-arrow-card" href="/partners">
<div><span class="label">DIRECTORY</span><h4>Partners</h4></div>
<span class="arrow">→</span>
</a>
</div>
</div>
