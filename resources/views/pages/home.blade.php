    ...
    <div class="wrap">
        ...
        <div class="marquee home-exec-marquee">
            <div class="marquee-track" style="animation-duration:95s;">
                ...
                <button type="button" class="member-chip tappable" data-photo="/images/CEC/dama.jpg" data-name="President" data-role="Executive Committee" data-bio="President FEHSU and leads FEHSU's overall strategy and represents the federation at national and international forums.">
                    <div class="photo"><img alt="Chairperson" src="/images/CEC/dama.jpg" /></div>
                ...
                <button type="button" class="member-chip tappable" data-photo="/images/CEC/dama.jpg" data-name="Chairperson" data-role="Executive Committee" data-bio="President FEHSU and leads FEHSU's overall strategy and represents the federation at national and international forums.">
                    <div class="photo"><img alt="Chairperson" src="/images/CEC/dama.jpg" /></div>
        ...
        <div class="org-showcase-block">
            ...
            <div class="org-slider">
                ...
                <div class="org-slider-track">
                    ...
                    <div class="org-logo-box" aria-hidden="true"><img src="/images/PHS.png" alt="" loading="lazy" onerror="this.parentElement.textContent='MA3'"></div>
                    ...
                    <div class="org-logo-box" aria-hidden="true"><img src="/images/bwera.jpg" alt="" loading="lazy" onerror="this.parentElement.textContent='MA6'"></div>
                    <div class="org-logo-box" aria-hidden="true"><img src="/images/PHS.png" alt="" loading="lazy" onerror="this.parentElement.textContent='MA7'"></div>
                    ...
                    <div class="org-logo-box" aria-hidden="true"><img src="/images/bwera.jpg" alt="" loading="lazy" onerror="this.parentElement.textContent='MA9'"></div>
                    <div class="org-logo-box" aria-hidden="true"><img src="/images/PHS.png" alt="" loading="lazy" onerror="this.parentElement.textContent='MA10'"></div>
